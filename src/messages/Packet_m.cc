...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->priorityLevel);
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->priorityLevel);
    doParsimUnpacking(b,this->type);
    doParsimUnpacking(b,this->timestamp);
}

int Packet::getPriorityLevel() const
{
    return this->priorityLevel;
}

void Packet::setPriorityLevel(int priorityLevel)
{
...
void Packet::setType(const char * type)
{
    this->type = type;
}
...
unsigned int PacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_priorityLevel
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "priorityLevel") == 0) return baseIndex + 0;
...
std::string PacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Packet *pp = omnetpp::fromAnyPtr<Packet>(object); (void)pp;
    switch (field) {
        case FIELD_priorityLevel: return long2string(pp->getPriorityLevel());
...
void PacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    Packet *pp = omnetpp::fromAnyPtr<Packet>(object); (void)pp;
    switch (field) {
        case FIELD_priorityLevel: pp->setPriorityLevel(string2long(value)); break;
...
omnetpp::cValue PacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Packet *pp = omnetpp::fromAnyPtr<Packet>(object); (void)pp;
    switch (field) {
        case FIELD_priorityLevel: return pp->getPriorityLevel();
...
void PacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    Packet *pp = omnetpp::fromAnyPtr<Packet>(object); (void)pp;
    switch (field) {
        case FIELD_priorityLevel: pp->setPriorityLevel(omnetpp::checked_int_cast<int>(value.intValue())); break;
