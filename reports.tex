...
\begin{titlepage}
    \centering
    {\Huge \textbf{QoS-AR: Quality-of-Service Adaptive Router}}\par
    \vspace{0.5em}
    {\Large SmartQueue Project}\par
    \vspace{1.5em}
    \rule{\textwidth}{1pt}\\[0.8em]
    {\large \textbf{Course Title:} \CourseTitle}\\[0.25em]
    {\large \textbf{Course Code:} \CourseCode}\\[0.8em]
    \rule{\textwidth}{1pt}
    \vspace{2em}
    \begin{tabular}{p{0.47\textwidth} p{0.47\textwidth}}
        \multicolumn{1}{c}{\textbf{Submitted By}} & \multicolumn{1}{c}{\textbf{Submitted To}} \\
        \SubmittedByName & \SubmittedToA \\
        \SubmittedByID & \SubmittedToATitle \\
